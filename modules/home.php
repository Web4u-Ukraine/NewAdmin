...
<<<<<<< HEAD
                ...
                <p>
                    Індивідуальна система управління готова до вашого використання
                </p>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="hpanel">
                    <div class="panel-heading">
                        ...
                        Статистика по основному сайту
                    </div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-3 text-center">
                                <div class="small">
                                    <i class="fa fa-bolt"></i> Перегляди
                                </div>
                                <div>
                                    <h1 class="font-extra-bold m-t-xl m-b-xs">
                                        226,802
                                    </h1>
                                    <small>переглянуто сторінок за останній місяць</small>
                                </div>
                                <div class="small m-t-xl">
                                    <i class="fa fa-clock-o"></i> Дані за серпень
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="text-center small">
                                    <i class="fa fa-laptop"></i> Кількість користувачів (Серпень)
                                </div>
                            ...
                            <div class="col-md-3 text-center">
                                <div class="small">
                                    <i class="fa fa-clock-o"></i> Зареєстровано користувачів
                                </div>
                                <div>
                                    <h1 class="font-extra-bold m-t-xl m-b-xs">
                                        117
                                    </h1>
                                    <small>за серпень</small>
                                </div>
                                <div class="small m-t-xl">
                                    <i class="fa fa-clock-o"></i> Остання реєстрація 13.08.2015
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="panel-footer">
                        Останнє оновлення: 16.08.2015
                    </div>
                </div>
            </div>
        </div>
